...
export const PROFILE = {
  ...
  location: "India",
  email: "sanskar1211singh@gmail.com",
  phone: "+91 7488233131",
  linkedin: "https://www.linkedin.com/in/sanskarsingh1211/",
  summary:
...
export const PROJECTS = [
  {
    ...
    color: "#0078D4",
    problem:
      "Global enterprises operating with fragmented CRM systems, manual sales pipelines, and disconnected service operations across regions.",
    architecture: [
    ...
    solution:
      "End-to-end D365 implementations: discovery, solution design, customization, integration, data migration, training, and hyper-care.",
    outcome:
      "Unified 360° customer view, automated workflows, 60%+ reduction in manual effort, faster time-to-insight for sales and service teams.",
  },
  {
    id: "azure-infra",
    ...
    color: "#00B8FF",
    problem:
      "Legacy on-premise infrastructure with high costs, limited scalability, and compliance gaps.",
    architecture: [
    ...
    solution:
      "Designed and deployed multi-region Azure landing zones, hybrid identity, networking, and security baselines.",
    outcome:
      "Improved reliability, 40% TCO reduction, hardened security posture, and elastic scale for global workloads.",
  },
  {
    id: "aws-migration",
    ...
    color: "#FF9900",
    problem:
      "Workloads trapped in legacy data centers with limited disaster recovery and no ML capability.",
    architecture: [
      "AWS EC2 · S3 · RDS · VPC",
    ...
    solution:
      "Lift-and-shift + refactor migration to AWS, with ML services integrated for analytics and automation.",
    outcome:
      "Fully migrated production workloads, integrated ML pipelines, real-time analytics, and improved resilience.",
  },
  {
    id: "baas",
    ...
    color: "#6EEBFF",
    problem:
      "Clients lacked enterprise-grade backup, retention policies, and disaster recovery capabilities.",
    architecture: [
      "Veeam · Acronis",
      "Azure Blob · AWS S3",
      "Azure Backup · Site Recovery",
    ...
    solution:
      "Built a multi-tenant BaaS platform with automated onboarding, retention, and DR orchestration.",
    outcome:
      "Predictable RTO/RPO, regulatory compliance, recurring managed-service revenue stream.",
  },
  {
    id: "zoho-impl",
    ...
    color: "#E42528",
    problem:
      "Disjointed sales, finance, and support tools with no unified view of the customer.",
    architecture: [
      "Zoho CRM · Books · Desk",
    ...
    solution:
      "Deployed and customized the full Zoho One suite, with bespoke Creator apps and analytics.",
    outcome:
      "Single source of truth across departments, automation of lead-to-cash, measurable uplift in conversions.",
  },
  {
    id: "power-automate",
    ...
    color: "#742774",
    problem:
      "High-volume repetitive processes across HR, finance, and operations slowing the business.",
    architecture: [
    ...
    solution:
      "Designed and deployed enterprise-grade Power Platform solutions for approvals, onboarding, and field operations.",
    outcome:
      "60%+ reduction in manual processing, faster cycle times, audit-ready approval trails.",
  },
];
...
export const CERTIFICATIONS = [
  ...
  {
    id: "atl-jira",
    name: "Atlassian Certified: Jira Administration",
    issuer: "Atlassian",
    color: "#2684FF",
    icon: "🛠",
  },
  {
    id: "atl-conf",
    name: "Atlassian Certified: Confluence Administration",
    issuer: "Atlassian",
    color: "#0052CC",
    icon: "📘",
  },
  {
    id: "ms-fund",
    name: "Microsoft Certified: Fundamentals (Azure / M365)",
    issuer: "Microsoft",
    color: "#00F0FF",
    icon: "🧩",
  },
...
export const NAV_CHAPTERS = [
  ...
  {
    id: "nexus",
    label: "02 · SKILL NEXUS",
    desc: "Neural Network of Expertise",
  },
  {
    id: "career",
    label: "03 · CAREER TIMELINE",
    desc: "Time Tunnel of Experience",
  },
  { id: "vault", label: "04 · PROJECT VAULT", desc: "Holographic Archive" },
  {
    id: "certifications",
    label: "05 · CERTIFICATION WALL",
    desc: "Hall of Achievements",
  },
  {
    id: "architecture",
    label: "05B · ARCHITECTURE",
    desc: "Reference Enterprise Topology",
  },
  {
    id: "contact",
    label: "06 · CONTACT HORIZON",
    desc: "Build the Future Together",
  },
];
